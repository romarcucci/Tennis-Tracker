...
public class MainActivity extends FragmentActivity
        implements History.OnFragmentInteractionListener,
        NewGame.OnFragmentInteractionListener,
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.new_game) {
            transaction.replace(R.id.frame, new NewGame());
            transaction.commit();
        } else if (id == R.id.history) {
            transaction.replace(R.id.frame, new History());
            transaction.commit();
        }
